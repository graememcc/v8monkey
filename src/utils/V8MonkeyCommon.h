...
*/
        ...
        // Trigger an error that is not catchable by a user-supplied handler
        // Note the need to modify visibility with EXPORT_FOR_TESTING_ONLY: this ensures we can tests that only require
        // header files link correctly if the header under test contains asserts
